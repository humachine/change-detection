...
def getstrings(fname=None):
    if fname==None:
        ...
        imname='images_consolidated\\4_5_a.png'
        imname='images_consolidated\\4_6_a.png'
    ...
    for i in list2:
        ...
        img3[char.ul0-30:char.lr0+31, char.ul1-30:char1.lr1+31]=True
    ...
    for i in list1:
        ...
        img2[char.ul0-30:char1.lr0+31, char.ul1-30:char.lr1+31]=True
    #toimage(img2).show()
    imsave('Outputs\\stringmaskdil'+fname+'.png', img2)
